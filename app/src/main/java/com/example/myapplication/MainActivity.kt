...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val transNameArray = arrayOf("腳踏車", "機車", "汽車", "巴士","飛機","郵輪")
        val transPhotoIdArray = arrayOf(R.drawable.trans1,R.drawable.trans2,R.drawable.trans3,R.drawable.trans4,R.drawable.trans5,R.drawable.trans6)
